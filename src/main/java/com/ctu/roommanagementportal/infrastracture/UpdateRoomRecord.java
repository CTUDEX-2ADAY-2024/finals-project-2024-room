...
public class UpdateRoomRecord {
    ...
    private static void displayRoomInfo(Room room) {
        ...
        System.out.println("Building Location: " + room.getBuildingLocation());
        System.out.println("Capacity: " + room.getCapacity());
        System.out.println("Room Status: " + (room.getRoomStatus() ? "Available" : "Unavailable"));
        System.out.println("Maintenance Notes: " + room.getMaintenanceNotes());
        System.out.println("Projector Availability: " + (room.isHasProjector() ? "Yes" : "No"));
        System.out.println("Number of Chairs: " + room.getNumOfChairs());

        if (room instanceof RoomType.Classroom) {
            System.out.println("Whiteboard: " + (((RoomType.Classroom) room).isWhiteboard() ? "Yes" : "No"));
        } else if (room instanceof RoomType.CompLaboratory) {
            System.out.println("Number of Computers: " + ((RoomType.CompLaboratory) room).getNumOfComputers());
        } else if (room instanceof RoomType.Library) {
            System.out.println("Number of Desks: " + ((RoomType.Library) room).getNumOfDesks());
        } else if (room instanceof RoomType.Smartroom) {
            System.out.println("TV: " + (((RoomType.Smartroom) room).isTv() ? "Yes" : "No"));
            System.out.println("Internet Access: " + (((RoomType.Smartroom) room).isInternetAccess() ? "Yes" : "No"));
        }
    }
    ...
    private static int promptForUpdateChoice(Scanner scanner) {
        ...
        System.out.println("4. Update building location");
        System.out.println("5. Update maintenance notes");
        System.out.println("6. Update projector availability");
        System.out.println("7. Update number of chairs");
        System.out.println("8. Room Type Specific Attributes");
        System.out.println("-> (whiteboard, computers, desks, tv, internet)");
        System.out.println("9. Exit current update");
        System.out.print("\nEnter your choice: ");
    ...
    private static boolean updateBuildingLocation(Scanner scanner, InsertRecords insertRecords, String roomName, String buildingLocation, Room existingRoom) {
        ...
        if (!newLocation.equals(existingRoom.getBuildingLocation())) {
    ...
    private static boolean updateRoomName(Scanner scanner, InsertRecords insertRecords, String roomName, String buildingLocation, Room existingRoom) {
        ...
        if (!newName.equals(existingRoom.getRoomName())) {
