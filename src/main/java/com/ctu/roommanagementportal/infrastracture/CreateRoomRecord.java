...
//        CreateTables createTables = new CreateTables();
        ...
        int roomType = InputValidator.validateRoomTypeInput(scanner);
        ...
        try {
            ...
            // Handle SQl exception if saving files
...
//            e.printStackTrace();
     ...
     */
    private static Room createRoom(Scanner scanner, int roomType) {

        // Prompt user to enter room details
        System.out.println("Enter room number: ");
        String roomNumber = InputValidator.validateStringInput(scanner);
        ...
        String buildingLocation = InputValidator.validateStringInput(scanner);

        System.out.println("Provide here the things that needs maintenance: ");
        String maintenanceNotes = InputValidator.validateStringInput(scanner);

        // Create different types of rooms based on room type
        switch (roomType) {
            case 1 -> {
    ...
    // Missing: Prompt that displays the inputs that is stored in Database
